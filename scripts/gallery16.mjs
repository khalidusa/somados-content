...
const plans = [
  ...
  ['03-arches', 'arches', [A, I2, A3], b(V, { headline: fillPair(HEADLINES.multi[0], V), sub: SUBS.multi[0], chips: BENEFITS,
  ...
  ['09-routemap', 'routemap', [I3, A], b(VA, { headline: fillPair(HEADLINES.destination[3], VA), plane: 'plane-a.png' })],
  ...
  ['13-polaroids', 'polaroids', [A, I, A3], b(V, { headline: fillPair(HEADLINES.multi[2], V), sub: SUBS.multi[2],
      cities: [{ ar: 'أنطاليا' }, { ar: 'إسطنبول' }, { ar: 'أنقرة' }] })],
  ['14-quad', 'quad', [I2, A, A3, I3], b(V, { headline: fillPair(HEADLINES.multi[1], V), badge: 'تركيا', badgeSub: 'أربع وجهات' })],
